# -*- coding: utf-8 -*-
"""
Created on Thu Jul  9 13:23:30 2026
...
# =====================================================
def load_mode():
    return (CONFIG_PATH / "mode.txt").read_text(
        encoding="utf-8"
    ).strip().lower()
# =====================================================
# RELOJ
...
async def run_multi_agent(questions):
    ...
    for i, q in enumerate(questions, 1):
        ...
        save_multi_result(q, answer, tiempo)        
...
# SAVE
# =====================================================
def save_multi_result(q, a, tiempo):
    with open(RESULT_MULTI_FILE, "a", encoding="utf-8") as f:
        f.write("\n" + "="*80 + "\n")
        f.write(f"PREGUNTA: {q}\n")
        f.write(f"TIEMPO: {tiempo:.3f} segundos\n")
        f.write(f"RESPUESTA:\n{a}\n")
async def buscar_en_internet(query: str):
    print(f"\nBUSCANDO: {query}\n")
...
async def main():
    ...
    # ==========================================================
        ...
        print("\n" + "="*80)
        print("FINALIZADO MULTIAGENTE")
        print("="*80)

    # ==========================================================
    # CONSENSUS
    # (Compara las respuestas ya existentes)
    # ==========================================================
    elif mode == "consensus":
        ...
        for q in questions:
            ...
            if (q not in single_results or
                q not in single_tools_results or
                q not in multi_results):

                print(f"\nNo existen todas las respuestas para: {q}")
                continue
